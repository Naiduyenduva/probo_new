...
const Button = ({text,variant='primary',buttonwidth}) => {
    const variantStyles = {
  ...
  return (
    <button className={`font-semibold flex justify-center rounded-xl ${variantStyles[variant]} ${buttonwidth}`}>{text}</button>
  )
}
